        ...
        {this.state.FlatListItems != "" ? (
          <View>
              ...
              {this.state.notlucid ? (
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.searchLucidity("not");
                      this.setState({ notlucid: true, lucid: false });
                    }}
                  >
              ...
              {this.state.lucid ? (
                ...
                >
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.searchLucidity("lucid");
                      this.setState({ lucid: true, notlucid: false });
                    }}
                  >
            ...
            {this.state.visible_flatlist ? (
              ...
              >
                <Image
                  source={Static_Images.image_first_icon}
                  style={{
                    width: 70,
                    height: 70,
                    resizeMode: "contain",
